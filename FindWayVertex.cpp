...
public:
    Vertex():x(0), y(0),z(0){};
    ~Vertex(){};
    Vertex(float v_x, float v_y, float v_z): x(v_x), y(v_y), z(v_z)
    {
     index=Quantity_vertex;
     Quantity_vertex++;
    }
    inline void Initialization(float, float, float);        //initialization vertex
...
void Vertex::Initialization(float v_x, float v_y, float v_z)    //initialization vertex
{
   x=v_x;
   y=v_y;
   z=v_z;
...
bool VisitedPoint[MAX_QUANTITY_VERTEX];            // for Djekstru
float DistantPoint[MAX_QUANTITY_VERTEX]={0};       // for Djekstru
bool InitializationFileStl(string FileName)         //File initialization
{
    FILE *file_stl;
                                ...
                                //  cout<<"NORMAL VECTOR:"<<endl;
                                 ...
                                 // cout<<Coord_vertex[3]<<" "<<Coord_vertex[4]<<" "<<Coord_vertex[5]<<endl;
                                   ...
                                   if (!verify)         //if vertex different then add vertex
                                   {
                                       ...
                                       Massive_Vertex[Quantity_vertex].Initialization(Coord_vertex[3],Coord_vertex[4],Coord_vertex[5]);
                                 ...
                                 // cout<<Coord_vertex[6]<<" "<<Coord_vertex[7]<<" "<<Coord_vertex[8]<<endl;
                                  ...
                                  if (!verify)      //if vertex different then add vertex
                                  {
                                      ...
                                      Massive_Vertex[Quantity_vertex].Initialization(Coord_vertex[6],Coord_vertex[7],Coord_vertex[8]);
                                 ...
                                 // cout<<Coord_vertex[9]<<" "<<Coord_vertex[10]<<" "<<Coord_vertex[11]<<endl;
                                  ...
                                  if (!verify)       //if vertex different then add vertex
                                  {
                                      ...
                                      Massive_Vertex[Quantity_vertex].Initialization(Coord_vertex[9],Coord_vertex[10],Coord_vertex[11]);
...
int Index_way[MAX_QUANTITY_VERTEX];
int length_road=0;
float bfs (int start, int end) //Bfs
{
    int index_min=0;
    queue <int> turn;
...
int main(int argc, char* argv[])
{
    ...
    if(!InitializationFileStl(FileName))
        return -1;
